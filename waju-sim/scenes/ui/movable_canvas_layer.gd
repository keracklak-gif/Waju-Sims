...
const DEFAULT_UI_POSITIONS = {
	...
	"target_debuff_bar": [0.463, 0.47],
	"healer_ability_bar": [0.463, 0.6],
	"healer_buff_bar": [0.463, 0.535],
...
const DEFAULT_UI_SCALES = {
	...
	"target_debuff_bar": Vector2(1, 1),
	"healer_ability_bar": Vector2(1, 1),
	"healer_buff_bar": Vector2(1, 1),
