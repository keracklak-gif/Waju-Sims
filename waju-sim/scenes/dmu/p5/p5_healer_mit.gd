...
##
## Fell Forces autos and Maddening Orchestra's spreads only hit some players
## ("targets": "aoe"), so P5Seq checks whether each one hit the player. Every
## Forsaken hit needs a fresh shield ("strict"), even the 3s-apart ones.
...
const MECHANICS := [
	{"name": "Ultima Repeater", "sheet_time": "0:49", "time": 5.7,
		...
		"carry": {}},
	{"name": "Fell Forces", "targets": "aoe", "sheet_time": "0:54", "time": 11.0,
		"new": {},
		"carry": {"White Mage": ["confession"], "Astrologian": ["collective_unconscious"],
			"Scholar": ["sacred_soil"], "Sage": ["holos", "kerachole"]}},
	{"name": "Fell Forces (2nd auto)", "targets": "aoe", "time": 14.2, "new": {}, "carry": {}},
	{"name": "Fell Forces (3rd auto)", "targets": "aoe", "time": 17.3, "new": {}, "carry": {}},
	...
	{"name": "Maddening Orchestra", "targets": "aoe", "sheet_time": "1:18", "time": 36.5,
	...
	{"name": "Maddening Orchestra (2nd hit)", "targets": "aoe", "time": 39.7, "new": {}, "carry": {}},
	{"name": "Maddening Orchestra (3rd hit)", "targets": "aoe", "time": 43.2, "new": {}, "carry": {}},
	{"name": "Fell Forces", "targets": "aoe", "sheet_time": "1:31", "time": 47.9,
		"new": {},
		"carry": {"Astrologian": ["sun_sign"], "Scholar": ["sacred_soil", "fey_illumination"],
			"Sage": ["kerachole"]}},
	{"name": "Fell Forces (2nd auto)", "targets": "aoe", "time": 51.0, "new": {}, "carry": {}},
	...
	{"name": "Ultima Repeater", "sheet_time": "2:11", "time": 87.6,
		...
		"carry": {}},
	{"name": "Fell Forces", "targets": "aoe", "sheet_time": "2:16", "time": 93.1,
		"new": {},
		"carry": {"White Mage": ["confession"], "Astrologian": ["collective_unconscious"],
			"Scholar": ["sacred_soil"], "Sage": ["kerachole"]}},
	{"name": "Fell Forces (2nd auto)", "targets": "aoe", "time": 96.1, "new": {}, "carry": {}},
	{"name": "Stray Entropy", "sheet_time": "2:42", "time": 118.4, "new": {}, "carry": {}},
	{"name": "Maddening Orchestra", "targets": "aoe", "sheet_time": "2:51", "time": 128.7,
		"new": {"Scholar": ["sacred_soil"], "Sage": ["kerachole"]},
		"carry": {}},
	{"name": "Maddening Orchestra (2nd hit)", "targets": "aoe", "time": 131.9, "new": {}, "carry": {}},
	{"name": "Maddening Orchestra (3rd hit)", "targets": "aoe", "time": 135.4, "new": {}, "carry": {}},
	{"name": "Fell Forces", "targets": "aoe", "sheet_time": "3:03", "time": 140.0, "new": {}, "carry": {}},
	{"name": "Fell Forces (2nd auto)", "targets": "aoe", "time": 143.1, "new": {}, "carry": {}},
	{"name": "Fell Forces (3rd auto)", "targets": "aoe", "time": 146.2, "new": {}, "carry": {}},
	{"name": "Forsaken (1st hit)", "strict": true, "sheet_time": "3:20", "time": 158.0,
		...
		"carry": {}},
	{"name": "Forsaken Bonds (2nd hit)", "strict": true, "sheet_time": "3:25", "time": 163.0,
	...
	{"name": "Forsaken (3rd hit)", "strict": true, "sheet_time": "3:28", "time": 166.0,
		"new": {"Astrologian": ["macrocosmos"], "Scholar": ["expedient"], "Sage": ["panhaima"]},
		"carry": {"White Mage": ["temperance"],
			"Astrologian": ["neutral_sect", "collective_unconscious"],
			"Scholar": ["fey_illumination", "sacred_soil"], "Sage": ["holos", "kerachole"]}},
	{"name": "Forsaken Bonds (4th hit)", "strict": true, "sheet_time": "3:34", "time": 171.0,
		"new": {},
		"carry": {"White Mage": ["temperance"], "Astrologian": ["neutral_sect"],
			"Scholar": ["fey_illumination", "expedient"], "Sage": ["holos", "panhaima"]}},
	{"name": "Forsaken (5th hit)", "strict": true, "sheet_time": "3:37", "time": 174.0,
		"new": {"White Mage": ["divine_caress"], "Astrologian": ["sun_sign"]},
		"carry": {"White Mage": ["temperance"], "Scholar": ["expedient"],
			"Sage": ["holos", "panhaima"]}},
	{"name": "Forsaken Bonds (6th hit)", "strict": true, "sheet_time": "3:42", "time": 179.0,
		"new": {"White Mage": ["confession"]},
		"carry": {"Astrologian": ["sun_sign"], "Scholar": ["expedient"], "Sage": ["panhaima"]}},
	{"name": "Forsaken (7th hit)", "strict": true, "sheet_time": "3:45", "time": 182.0,
		"new": {"Scholar": ["consolation"]},
		"carry": {"White Mage": ["confession"], "Astrologian": ["sun_sign"]}},
	{"name": "Forsaken Bonds (8th hit)", "strict": true, "sheet_time": "3:50", "time": 187.0,
...
static func check(index: int, controller: HealerActionController, job_name: String,
	...
	HealerMitCheck.check(MECHANICS[index], controller, job_name, fail_list, player_hit, hit_at)
